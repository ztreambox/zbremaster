...
ztreambox is a combination of software applications that allows you to use a Linux operating system as a
media center pc. ztreambox is based on Ubuntu desktop system, the XBMC media center and a video disk recorder (VDR).
For more informations look at www.ztreambox.org (english) or www.ztreambox.org (german).
...
Make a snapshot of the base installation so you can easily revert to a consistent state
...
This last script will prepare the new filesystem.squahfs from the modified chroot system and will create
an ISO file.
